...
function renderPlanning(){
  ...
  $$('[data-plan-remove]').forEach(b=>b.onclick=()=>{delete state.prefs.planning[b.dataset.planRemove];savePrefs();renderPlanning();renderHome();});
