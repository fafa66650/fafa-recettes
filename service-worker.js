const CACHE='fafatraining-recettes-20260914';
const CORE=[
  './','./index.html','./style.css?v=20260914','./app.js?v=20260914','./recipes.json?v=20260914','./menus.json?v=20260914','./manifest.json',
